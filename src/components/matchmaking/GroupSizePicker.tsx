...
const options: Array<{
  ...
  { value: 1, label: '1 person', detail: 'A focused one-on-one chat', accent: '01' },
  { value: 2, label: '2 people', detail: 'You + two new faces', accent: '02' },
  { value: 3, label: '3 people', detail: 'A lively group of four', accent: '03' },
]
  ...
  return (
    <section className="matchmaking-panel" aria-labelledby="matchmaking-title">
      ...
      <div className="panel-heading">
        ...
        <p>Choose the number of other people you would like in your next conversation.</p>
      </div>

      <div className="size-options" role="radiogroup" aria-label="People to meet">
        {options.map((option) => (
          <button
      ...
      <div className="panel-footer">
        ...
        <button className="primary-button" type="button" onClick={onSubmit} disabled={isSearching}>

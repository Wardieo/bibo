    ...
    <section className="moderator-shell" aria-labelledby="moderator-title">
      <div className="moderator-header">
        <div>
          ...
          <h1 id="moderator-title">Safety queue</h1>
        </div>
      ...
      <div className="report-table">
        ...
        {reports.map((report) => (
          <div className="report-row" key={report.user}>
            <span>
              <b className={`severity ${report.severity}`}>{report.severity}</b>
            </span>
            <span>
      ...
      <p className="moderator-footnote">
        Moderator actions are logged. Access to reports and evidence is
        restricted by server-side role permissions.
      </p>
    </section>
  );
}
